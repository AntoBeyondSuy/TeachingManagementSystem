...
<div class="col-md-2">
    <ul class="nav nav-pills nav-stacked" id="nav">
        ...
        <li><a href="/admin/showStudent">学生管理<span class="glyphicon glyphicon-user pull-right"></span></a></li>
        <li><a href="/admin/showTeacher">教师管理<span class="glyphicon glyphicon-user pull-right"></span></a></li>
